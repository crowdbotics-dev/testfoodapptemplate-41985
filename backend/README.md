...
## Project Structure
    ...
    ├── testfoodapptemplate_41985  # Django project configurations
...
1. Clone this repo and `cd testfoodapptemplate_41985`
...
2. Clone this repo and `cd testfoodapptemplate_41985`
